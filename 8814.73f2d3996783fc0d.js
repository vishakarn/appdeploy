...
const ActionSheet = class {
  constructor(hostRef) {
    ...
    this.isOpen = false;
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_5__.B);
    };
  ...
  present() {
    ...
    return (0,_Users_vishaka_Documents_officeWorkspace_tsrtcCustomerApp_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      yield (0,_overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_5__.f)(_this, 'actionSheetEnter', iosEnterAnimation, mdEnterAnimation);
      unlock();
    })();
  }
  /**
  ...
  dismiss(data, role) {
    ...
    return (0,_Users_vishaka_Documents_officeWorkspace_tsrtcCustomerApp_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const dismissed = yield (0,_overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_5__.g)(_this2, data, role, 'actionSheetLeave', iosLeaveAnimation, mdLeaveAnimation);
      if (dismissed) {
   ...
   */
  onDidDismiss() {
    return (0,_overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_5__.h)(this.el, 'ionActionSheetDidDismiss');
  }
  /**
   ...
   */
  onWillDismiss() {
    return (0,_overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_5__.h)(this.el, 'ionActionSheetWillDismiss');
  }
  buttonClick(button) {
    var _this3 = this;
    return (0,_Users_vishaka_Documents_officeWorkspace_tsrtcCustomerApp_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  getRadioButtons() {
    return this.getButtons().filter(b => {
      ...
      return role === 'radio' && !(0,_overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_5__.i)(role);
    });
  }
  /**
