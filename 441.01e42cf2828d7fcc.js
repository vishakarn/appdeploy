...
/* harmony import */ var _overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./overlays-Dg0q2_tJ.js */ 55906);
...
const StatusBar = {
  ...
  getStyle: function () {
    var _ref = (0,_Users_vishaka_Documents_officeWorkspace_tsrtcCustomerApp_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const engine = this.getEngine();
      if (!engine) {
...
const handleCanDismiss = /*#__PURE__*/function () {
  var _ref2 = (0,_Users_vishaka_Documents_officeWorkspace_tsrtcCustomerApp_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el, animation) {
    /**
     ...
     */
    const shouldDismiss = yield el.canDismiss(undefined, _overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_7__.G);
    if (!shouldDismiss) {
      return;
    }
    /**
...
const createSwipeToCloseGesture = (el, animation, statusBarStyle, onDismiss, onDragStart, onDragMove, onDragEnd) => {
  ...
  const gesture = (0,_index_CfgBF1SE_js__WEBPACK_IMPORTED_MODULE_14__.createGesture)({
    ...
    gesturePriority: _overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_7__.O,
    direction: 'y',
    threshold: 10,
    canStart,
    onStart,
...
const createSheetGesture = (baseEl, backdropEl, wrapperEl, initialBreakpoint, backdropBreakpoint, animation, breakpoints = [], expandToScroll, getCurrentBreakpoint, onDismiss, onBreakpointChange, onDragStart, onDragMove, onDragEnd) => {
  ...
  const enableBackdrop = () => {
     ...
     * the sheet.
     */
    baseEl.classList.remove(_overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_7__.F);
  };
  const disableBackdrop = () => {
     ...
     */
    baseEl.classList.add(_overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_7__.F);
  };
  /**
...
const Modal = class {
  constructor(hostRef) {
    ...
    this.triggerController = (0,_overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_7__.e)();
    ...
    this.onBackdropTap = () => {
      ...
      this.dismiss(undefined, _overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_7__.B);
    };
  ...
  connectedCallback() {
    ...
    (0,_overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_7__.j)(el);
    this.triggerChanged();
  }
  ...
  componentWillLoad() {
    ...
    if (!((_a = this.htmlAttributes) === null || _a === void 0 ? void 0 : _a.id)) {
      (0,_overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_7__.k)(this.el);
    }
  }
  componentDidLoad() {
    /**
  ...
  present() {
    ...
    return (0,_Users_vishaka_Documents_officeWorkspace_tsrtcCustomerApp_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      yield (0,_overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_7__.f)(_this2, 'modalEnter', iosEnterAnimation, mdEnterAnimation, {
  ...
  sheetOnDismiss() {
    ...
    this.animation.onFinish(/*#__PURE__*/(0,_Users_vishaka_Documents_officeWorkspace_tsrtcCustomerApp_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this3.currentBreakpoint = 0;
      _this3.ionBreakpointDidChange.emit({
        breakpoint: _this3.currentBreakpoint
      });
      yield _this3.dismiss(undefined, _overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_7__.G);
  ...
  cardOnDismiss() {
    ...
    this.animation.onFinish(/*#__PURE__*/(0,_Users_vishaka_Documents_officeWorkspace_tsrtcCustomerApp_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      yield _this4.dismiss(undefined, _overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_7__.G);
  ...
  dismiss(data, role) {
    ...
    return (0,_Users_vishaka_Documents_officeWorkspace_tsrtcCustomerApp_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      var _a;
      if (_this5.gestureAnimationDismissing && role !== _overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_7__.G) {
        return false;
      }
      ...
      const dismissed = yield (0,_overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_7__.g)(_this5, data, role, 'modalLeave', iosLeaveAnimation, mdLeaveAnimation, {
        presentingEl: presentingElement,
   ...
   */
  onDidDismiss() {
    return (0,_overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_7__.h)(this.el, 'ionModalDidDismiss');
  }
  /**
   * Returns a promise that resolves when the modal will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_7__.h)(this.el, 'ionModalWillDismiss');
  }
  /**
  ...
  dismissNestedModals() {
    ...
    return (0,_Users_vishaka_Documents_officeWorkspace_tsrtcCustomerApp_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      nestedModals === null || nestedModals === void 0 ? void 0 : nestedModals.forEach(/*#__PURE__*/function () {
        var _ref5 = (0,_Users_vishaka_Documents_officeWorkspace_tsrtcCustomerApp_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (modal) {
  ...
  render() {
    ...
    return (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.d, Object.assign({
      ...
      class: Object.assign({
        ...
        'overlay-hidden': true,
        [_overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_7__.F]: focusTrap === false
      ...
      key: 'd098688a65fb2d1befb255f0e59fd4c00b401092',
      ref: el => this.backdropEl = el,
      visible: this.showBackdrop,
      tappable: this.backdropDismiss,
      part: "backdrop"
    }), mode === 'ios' && (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      key: '96cd2e59a7d1c0de7c9afb8f8d366367b09fbc93',
      class: "modal-shadow"
      ...
      */
      ...
      key: '79dfbeb3fe5eee7dc3a243ad880d3f63184f3ab7',
