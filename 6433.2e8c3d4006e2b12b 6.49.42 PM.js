...
/* harmony import */ var _overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./overlays-Dg0q2_tJ.js */ 55906);
  ...
  switch (triggerAction) {
    case 'hover':
      ...
      triggerCallbacks = [{
        eventName: 'mouseenter',
        callback: function () {
          var _ref = (0,_Users_vishaka_Documents_officeWorkspace_tsrtcCustomerApp_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
            ev.stopPropagation();
            if (hoverTimeout) {
...
const configureKeyboardInteraction = popoverEl => {
  const callback = /*#__PURE__*/function () {
    var _ref2 = (0,_Users_vishaka_Documents_officeWorkspace_tsrtcCustomerApp_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
      var _a;
...
const Popover = class {
  constructor(hostRef) {
    ...
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_2__.B);
    };
  ...
  connectedCallback() {
    ...
    (0,_overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_2__.j)(el);
    configureTriggerInteraction();
  }
  ...
  componentWillLoad() {
    ...
    const popoverId = (_b = (_a = this.htmlAttributes) === null || _a === void 0 ? void 0 : _a.id) !== null && _b !== void 0 ? _b : (0,_overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_2__.k)(el);
  ...
  presentFromTrigger(_x3) {
    var _this = this;
    return (0,_Users_vishaka_Documents_officeWorkspace_tsrtcCustomerApp_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (event, focusDescendant = false) {
  ...
  present(event) {
    ...
    return (0,_Users_vishaka_Documents_officeWorkspace_tsrtcCustomerApp_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      yield (0,_overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_2__.f)(_this2, 'popoverEnter', iosEnterAnimation, mdEnterAnimation, {
      ...
      if (_this2.focusDescendantOnPresent) {
        (0,_overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_2__.n)(el);
      }
      unlock();
    })();
  }
  ...
  recalculateContentOnHeaderReady() {
    ...
    this.headerResizeObserver = new ResizeObserver(/*#__PURE__*/(0,_Users_vishaka_Documents_officeWorkspace_tsrtcCustomerApp_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      var _a;
  ...
  dismiss(_x4, _x5) {
    var _this4 = this;
    return (0,_Users_vishaka_Documents_officeWorkspace_tsrtcCustomerApp_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (data, role, dismissParentPopover = true) {
      ...
      const shouldDismiss = yield (0,_overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_2__.g)(_this4, data, role, 'popoverLeave', iosLeaveAnimation, mdLeaveAnimation, _this4.event);
      if (shouldDismiss) {
        if (destroyKeyboardInteraction) {
          destroyKeyboardInteraction();
   ...
   */
  onDidDismiss() {
    return (0,_overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_2__.h)(this.el, 'ionPopoverDidDismiss');
  }
  /**
   * Returns a promise that resolves when the popover will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_2__.h)(this.el, 'ionPopoverWillDismiss');
  }
  render() {
    ...
    return (0,_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_tcQvqkiX_js__WEBPACK_IMPORTED_MODULE_1__.d, Object.assign({
      ...
      class: Object.assign(Object.assign({}, (0,_theme_DiVJyqlX_js__WEBPACK_IMPORTED_MODULE_7__.g)(this.cssClass)), {
        ...
        [_overlays_Dg0q2_tJ_js__WEBPACK_IMPORTED_MODULE_2__.F]: focusTrap === false,
