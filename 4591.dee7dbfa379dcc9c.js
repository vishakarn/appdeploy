...
const Button = class {
  constructor(hostRef) {
    ...
    this.handleClick = ev => {
      ...
      } else if ((0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_1__.k)(el)) {
        this.submitForm(ev);
      }
    };
    this.onFocus = () => {
  ...
  componentWillLoad() {
    ...
    this.inheritedAttributes = (0,_helpers_HEqiOzXb_js__WEBPACK_IMPORTED_MODULE_1__.i)(this.el);
  }
  get hasIconOnly() {
